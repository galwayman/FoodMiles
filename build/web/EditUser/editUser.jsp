    ...
    <form id="form" name="form" action="../UpdateUser" method="post">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-7">
                    <label for="selectPic"class="text-info-view-food" style="width: 30rem; text-align: center;">
                        Select Profile Pic
                    </label>
                </div>
                <div class="col-3">
                    <select class="form-control option-view-food" id="selectPic" name="selectPic">
                        <option>0</option>
                        <option>1</option>
                        <option>2</option>
                        <option>3</option>
